namespace MoneyExchangeWinFormApp
{
    ...
    public partial class frmAdmin : Form
    {
        ...
        private void frmAdmin_Load(object sender, EventArgs e)
        {
            ...
            //MessageBox.Show(GlobalConfig.xmlFilePath);
            //MessageBox.Show(GlobalConfig.s);
            //MessageBox.Show(GlobalConfig.i.ToString());
            //MessageBox.Show(GlobalConfig.ft.ToString());
        ...
        private void frmAdmin_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            exchangeRateWriteService.WriteExchangeRateToFile(ExchangeRateList, GlobalConfig.fileType);
        }
